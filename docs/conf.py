...
import dls_logformatter

# -- General configuration ------------------------------------------------

# General information about the project.
project = "dls-logformatter"

# The full version, including alpha/beta/rc tags.
release = dls_logformatter.__version__
...
html_theme_options = dict(
    ...
    gitlab_url="https://gitlab.diamond.ac.uk/scisoft/dls-logformatter",
    icon_links=[],
...
ultimate_replacements = {
    "$" + "{repository_name}": "dls-logformatter",
    "$" + "{package_name}": "dls_logformatter",
